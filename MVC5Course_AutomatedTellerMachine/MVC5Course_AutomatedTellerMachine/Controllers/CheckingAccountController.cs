using MVC5Course_AutomatedTellerMachine.Models;
using System;
...
namespace MVC5Course_AutomatedTellerMachine.Controllers
{
    public class CheckingAccountController : Controller
    {
        ...
        {
            var checkingAccount = new CheckingAccount { Id=1, AccountNumber="000001257",
                FirstName ="Leonardo", LastName="Rossetti", Balance=500 };
